    ...
    <footer className="bg-[#1a1a1a] text-white py-12 px-6 md:px-16 font-sans">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div className="space-y-6">
          ...
          <p className="text-gray-400 text-sm leading-relaxed">
            Xưởng bánh gia truyền chuyên cung cấp sủi cảo, há cảo tươi ngon mỗi
            ngày. Mang hương vị ẩm thực Trung Hoa đích thực đến tận bàn ăn nhà
            bạn.
          </p>
        ...
        <div>
          ...
          <ul className="space-y-3 text-gray-400 text-sm">
            <li className="hover:text-[#f3b340] cursor-pointer">
              Sủi Cảo Nhân Thịt Hẹ
            </li>
            <li className="hover:text-[#f3b340] cursor-pointer">
              Há Cảo Tôm Tươi
            </li>
            <li className="hover:text-[#f3b340] cursor-pointer">
              Hoành Thánh Quảng Đông
            </li>
            <li className="hover:text-[#f3b340] cursor-pointer">
              Set Combo Gia Đình
            </li>
        ...
        <div className="relative">
          ...
          <div className="space-y-3 text-gray-400 text-sm mb-8">
            <p className="flex items-center gap-2">
              <span className="text-[#f3b340]">✉</span> phanthanhphong01@gmail.com
            </p>
            <p className="flex items-center gap-2">
      ...
      <div className="mt-16 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center text-xs text-gray-500">
        ...
        <div className="flex gap-6 mt-4 md:mt-0">
          <p className="hover:text-white cursor-pointer text-[#f3b340]">
            Chính sách bảo mật
          </p>
